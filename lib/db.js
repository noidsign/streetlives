...
module.exports = function(Config) {
  ...
  module.insertComment = function(comment, callback) {
    var query = "INSERT INTO {table} (location_id, comment, liked) VALUES('{id}', '{comment}', '{liked}');";
    var options = { table: 'comments', id: comment.location_id, comment: comment.comment, liked: comment.liked };
